#!/usr/bin/env python3
"""Presentation figure gallery — Plotly edition (modern, consistent, slide-ready).

Rebuilds ALL BreachBenchmark figures with ONE consistent design system (fixed per-model
colors, cleaned labels, no overlapping text) and exports static high-res PNGs via kaleido.
Replaces the earlier matplotlib gallery.

    ./.venv/bin/python scripts/make_figures_plotly.py

Primary figures always render; secondary Judge figures render if output/judge_scores.csv exists.
"""
